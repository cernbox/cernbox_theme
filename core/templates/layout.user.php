...
<!--[if (gt IE 9)|!(IE)]><!--><html class="ng-csp" data-placeholder-focus="false" lang="<?php p($_['language']); ?>" ><!--<![endif]-->
	...
	<header role="banner"><div id="header">
			...
			<a target="_blank" href="https://cernbox.cern.ch/cernbox/doc" tabindex="2" style="display:inline-block; position:relative; margin-left: 13%; height: 27px; padding-top: 18px">
			...
			<div id="settings" class="svg">
				...
				<div id="expand" tabindex="6" role="link" class="menutoggle">
					...
					<?php endif; ?>
					<span id="expandDisplayName"><?php  p(trim($_['user_displayname']) != '' ? ($_['user_displayname'] . ' (' . $_['user_uid'] . ')') : $_['user_uid']) ?></span>
