...
<!--[if (gt IE 9)|!(IE)]><!--><html class="ng-csp" data-placeholder-focus="false" lang="<?php p($_['language']); ?>" ><!--<![endif]-->
	...
	<header role="banner"><div id="header">
			...
			<a target="_blank" href="https://cernbox.cern.ch/cernbox/doc" tabindex="2" style="display:inline-block; position:relative; margin-left: 8%; height: 27px; padding-top: 18px">
